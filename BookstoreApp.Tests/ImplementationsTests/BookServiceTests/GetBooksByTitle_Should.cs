...
namespace BookstoreApp.Tests.ImplementationsTests.BookServiceTests
{
    ...
    public class GetBooksByTitle_Should
    {
        ...
        [TestMethod]
        public void ThrowNullException_WhenInvokedWithNullTitle()
        {
            var mapperMock = new Mock<IMapper>();
            var unitOfWorkMock = new Mock<IUnitOfWork>();
            var repoMock = new Mock<IRepository<Book>>();
            ...
            Assert.ThrowsException<ArgumentNullException>(() => bookService.GetBooksByTitle(null));
        }

        [TestMethod]
        public void ThrowOutOfRangeException_WhenInvokedWithInvalidTitleLength()
        {
            var mapperMock = new Mock<IMapper>();
            var unitOfWorkMock = new Mock<IUnitOfWork>();
            var repoMock = new Mock<IRepository<Book>>();
